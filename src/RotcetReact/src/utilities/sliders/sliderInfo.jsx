...
const SliderInfo = props => {
    ...
    return (
        <div className={'slider_info' + (position === (props.elementsNumber - 1) / props.elementsOnScreen ? ' slider_info--last' : '')
        ...
        onMouseMove={props.mouseMove} onMouseDown={props.mouseStart} onMouseUp={props.mouseEnd}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                { position === 0 || position === (props.elementsNumber - 1) / props.elementsOnScreen ?
